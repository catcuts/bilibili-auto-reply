      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <AutoReplyControl userId={userId} onProcessComplete={handleProcessComplete} />
            
            {processResults && (
              <div className="bg-white shadow sm:rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium leading-6 text-gray-900">处理结果</h3>
                  <div className="mt-4">
                              ...
                              {result.success ? (
                                result.noMatchingRule ? (
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                      使用规则: {result.ruleName}
                                    </p>
                                    {result.ruleType && (
                                      <p className="text-sm text-gray-500">
                                        规则类型: {
                                          result.ruleType === 'general' ? '通用回复' :
                                          result.ruleType === 'greeting' ? '问候语' :
                                          result.ruleType === 'faq' ? '常见问题' :
                                          result.ruleType === 'promotion' ? '推广内容' :
                                          result.ruleType === 'custom' ? '自定义类型' :
                                          '通用回复'
                                        }
                                      </p>
                                    )}
            ...
            <div className="bg-white shadow sm:rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg font-medium leading-6 text-gray-900">快速导航</h3>
