        ...
        {loading && !isCreating && !editingRule ? (
          ...
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium leading-6 text-gray-900">创建新规则</h3>
              <RuleForm userId={userId} onSubmit={handleCreateRule} onCancel={handleCancel} />
            </div>
          </div>
        ) : editingRule ? (
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium leading-6 text-gray-900">编辑规则</h3>
              <RuleForm 
